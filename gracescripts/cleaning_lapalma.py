...
path = "/home/gfinger/database_project/LaPalma2023/"

### READING IN FILES
event_df= pd.read_csv(path + "LaPalma2023_EventData.csv")
specimen_df= pd.read_csv(path + "LaPalma2023_SpecimenData.csv")
dna_df= pd.read_csv(path + "LaPalma2023_DNAextractions.csv")


### GETTING CORRECT COLUMN NAMES FROM DB ###
conn = sqlite3.connect('panama_specimens.db')
cursor = conn.cursor()
